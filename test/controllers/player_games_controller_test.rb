...
class PlayerGamesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create player_game" do
    assert_difference('PlayerGame.count') do
      post player_games_url, params: { player_game: { game_id: @player_game.game_id, player_id: @player_game.player_id } }, as: :json
    end
  ...
  test "should update player_game" do
    patch player_game_url(@player_game), params: { player_game: { game_id: @player_game.game_id, player_id: @player_game.player_id } }, as: :json
    assert_response 200
  end
